...
static const char *fonts[]          = { "monospace:size=11", "fontawesome:size=11:antialias=true:autohint=true" };
...
/* layout(s) */
static const float mfact     = 0.5;  /*0.55;  factor of master area size [0.05..0.95] */
...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,             XK_v, 	   spawn,          SHCMD("brave https://discord.com/app") },
	...
	{ MODKEY|ShiftMask,             XK_d,      togglefullscr,  {0} },
