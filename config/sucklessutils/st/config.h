 ...
 */
static char *font = "Inconsolata Nerd Font:pixelsize=16";
//static char *font = "InconsolataNerd:pixelsize=16:antialias=true:autohint=true";
...
static const char *colorname[] = {
  ...
  /* special colors */
  [256] = "#0e0d18", /* background */
  [257] = "#ada9b0", /* foreground */
};
